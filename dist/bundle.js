...
var _kress95$kress95$Misc$date = F3(
	function (day, month, year) {
		return A7(_rluiten$elm_date_extra$Date_Extra_Create$dateFromFields, year, month, day, 12, 0, 0, 0);
	});
var _kress95$kress95$Misc$flipTuple = function (_p0) {
	var _p1 = _p0;
	return {ctor: '_Tuple2', _0: _p1._1, _1: _p1._0};
};
var _kress95$kress95$Misc_ops = _kress95$kress95$Misc_ops || {};
_kress95$kress95$Misc_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});

var _kress95$kress95$Data_Page$Page = F3(
	function (a, b, c) {
		return {title: a, slug: b, content: c};
	});

var _kress95$kress95$Content_Pages_HelloWorld$content = '\n    Hey, this is markdown.\n\n    ';
var _kress95$kress95$Content_Pages_HelloWorld$page = {title: 'Hello, World!', slug: 'hello-world', content: _kress95$kress95$Content_Pages_HelloWorld$content};

var _kress95$kress95$Content_Pages$pages = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
		_0: _kress95$kress95$Content_Pages_HelloWorld$page,
		_1: {ctor: '[]'}
	});
var _kress95$kress95$Content_Pages$index = _elm_lang$core$Dict$fromList(
	A2(
		_elm_lang$core$List$map,
		function (_p0) {
			return A2(
				...
				_kress95$kress95$Misc$flipTuple(_p0));
		},
		_elm_lang$core$Array$toIndexedList(_kress95$kress95$Content_Pages$pages)));
var _kress95$kress95$Content_Pages$fromSlug = function (str) {
	return A2(
		_elm_lang$core$Maybe$andThen,
		A2(_elm_lang$core$Basics$flip, _elm_lang$core$Array$get, _kress95$kress95$Content_Pages$pages),
		A2(_elm_lang$core$Dict$get, str, _kress95$kress95$Content_Pages$index));
};

var _kress95$kress95$Data_Post$simplePost = function (_p0) {
	var _p1 = _p0;
	return {title: _p1.title, slug: _p1.slug, description: _elm_lang$core$Maybe$Nothing, content: _p1.content, date: _p1.date, discussion: _elm_lang$core$Maybe$Nothing, image: _elm_lang$core$Maybe$Nothing};
};
var _kress95$kress95$Data_Post$Post = F7(
	function (a, b, c, d, e, f, g) {
		return {title: a, slug: b, description: c, content: d, date: e, discussion: f, image: g};
	});
var _kress95$kress95$Data_Post$SimplePost = F4(
	function (a, b, c, d) {
		return {title: a, slug: b, content: c, date: d};
	});

var _kress95$kress95$Content_Posts_HelloWorld$content = '\n    Hey, this is markdown.\n\n    ';
var _kress95$kress95$Content_Posts_HelloWorld$description = 'My first post with this not-so-scalable blog.';
var _kress95$kress95$Content_Posts_HelloWorld$post = {
	title: 'Hello, World!',
	slug: 'hello-world',
	date: A3(_kress95$kress95$Misc$date, 25, _elm_lang$core$Date$Aug, 2017),
	description: _elm_lang$core$Maybe$Just(_kress95$kress95$Content_Posts_HelloWorld$description),
	content: _kress95$kress95$Content_Posts_HelloWorld$content,
	discussion: _elm_lang$core$Maybe$Nothing,
	image: _elm_lang$core$Maybe$Nothing
};

var _kress95$kress95$Content_Posts$posts = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
		_0: _kress95$kress95$Content_Posts_HelloWorld$post,
		_1: {
			ctor: '::',
			_0: _kress95$kress95$Content_Posts_HelloWorld$post,
			_1: {
...
var _kress95$kress95$Content_Posts$index = _elm_lang$core$Dict$fromList(
	A2(
		_elm_lang$core$List$map,
		function (_p0) {
			return A2(
		...
		_elm_lang$core$Array$toIndexedList(_kress95$kress95$Content_Posts$posts)));
var _kress95$kress95$Content_Posts$fromSlug = function (str) {
	return A2(
		_elm_lang$core$Maybe$andThen,
		A2(_elm_lang$core$Basics$flip, _elm_lang$core$Array$get, _kress95$kress95$Content_Posts$posts),
		A2(_elm_lang$core$Dict$get, str, _kress95$kress95$Content_Posts$index));
};

var _kress95$kress95$Data_Component$feedback = function (_p0) {
	var _p1 = _p0;
	return _p1.feedback;
};
var _kress95$kress95$Data_Component$apply = function (_p2) {
	var _p3 = _p2;
	return _p3.apply;
};

var _kress95$kress95$Element_Layout$footer = A2(
...
var _kress95$kress95$Element_Layout$content = _elm_lang$html$Html$article(
	{ctor: '[]'});
var _kress95$kress95$Element_Layout$navbar = function () {
	var links = {
		ctor: '::',
		_0: A2(
...
var _kress95$kress95$Element_Layout$header = A2(
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Chris'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('(também conhecido como kress ou cferraz)'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _kress95$kress95$Element_Style$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'dreamwriter', _p0));
}(
	{
		ctor: '::',
...
var _kress95$kress95$Element_Style$style = A3(
		...
		_0: A2(
			...
			function (_) {
				...
				_rtfeldman$elm_css$Css$compile(
					{
						ctor: '::',
						_0: _kress95$kress95$Element_Style$css,
						_1: {ctor: '[]'}
					}))),
		_1: {ctor: '[]'}
	},
...
var _kress95$kress95$Route$toString = function (route) {
	var pieces = function () {
		var _p0 = route;
		switch (_p0.ctor) {
			case 'Home':
...
var _kress95$kress95$Route$slug = function (base) {
	var slugParser = function (str) {
		return A2(
			_elm_lang$core$Result$map,
			_elm_lang$core$Basics$always(str),
			A2(
				_elm_lang$core$Result$fromMaybe,
				A2(
					_elm_lang$core$Basics_ops['++'],
					'page ',
					A2(_elm_lang$core$Basics_ops['++'], str, ' not found')),
				base(str)));
	};
	return A2(_evancz$url_parser$UrlParser$custom, 'SLUG', slugParser);
};
var _kress95$kress95$Route$modifyUrl = function (_p1) {
	return _elm_lang$navigation$Navigation$modifyUrl(
		_kress95$kress95$Route$toString(_p1));
};
var _kress95$kress95$Route$href = function (route) {
	return _elm_lang$html$Html_Attributes$href(
		_kress95$kress95$Route$toString(route));
};
var _kress95$kress95$Route$Post = function (a) {
	return {ctor: 'Post', _0: a};
};
var _kress95$kress95$Route$Page = function (a) {
	return {ctor: 'Page', _0: a};
};
var _kress95$kress95$Route$Home = {ctor: 'Home'};
var _kress95$kress95$Route$route = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _kress95$kress95$Route$Home, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_kress95$kress95$Route$Page,
				A2(
					_evancz$url_parser$UrlParser_ops['</>'],
					_evancz$url_parser$UrlParser$s('page'),
					_kress95$kress95$Route$slug(_kress95$kress95$Content_Pages$fromSlug))),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_kress95$kress95$Route$Post,
					A2(
						_evancz$url_parser$UrlParser_ops['</>'],
						_evancz$url_parser$UrlParser$s('post'),
						_kress95$kress95$Route$slug(_kress95$kress95$Content_Posts$fromSlug))),
				_1: {ctor: '[]'}
			}
		}
	});
var _kress95$kress95$Route$fromLocation = function (location) {
	return A2(_evancz$url_parser$UrlParser$parseHash, _kress95$kress95$Route$route, location);
};

var _kress95$kress95$Views_Home$subscriptions = F2(
	function (config, model) {
		return _elm_lang$core$Platform_Sub$none;
	});
var _kress95$kress95$Views_Home$posts = function () {
	var description = F2(
		function (config, _p0) {
			var _p1 = _p0;
			return A2(
	...
	var title = F2(
		function (config, _p3) {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: _kress95$kress95$Route$href(
						_kress95$kress95$Route$Post(_p4.slug)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
				...
				A2(
					...
					_elm_lang$core$Basics$identity,
					{
						...
						_0: _elm_lang$core$Maybe$Just(
							A2(title, config, post)),
						_1: {
							ctor: '::',
							_0: A2(description, config, post),
							_1: {ctor: '[]'}
						}
					}));
		});
		...
		function (config, _p5) {
			...
			return A2(
				...
				_elm_lang$core$Array$toList(
					A3(_elm_lang$core$Array$slice, _p7, (_p7 + 1) * 10, _kress95$kress95$Content_Posts$posts)));
		});
	return view;
}();
var _kress95$kress95$Views_Home$view = F2(
	function (config, model) {
		return A2(
			...
			{
				ctor: '::',
				_0: _kress95$kress95$Element_Layout$header,
				_1: {
					ctor: '::',
					_0: _kress95$kress95$Element_Layout$navbar,
					_1: {
						ctor: '::',
						_0: A2(
						...
						_1: {
							ctor: '::',
							_0: _kress95$kress95$Element_Layout$content(
								A2(_kress95$kress95$Views_Home$posts, config, model)),
							_1: {
								ctor: '::',
								_0: _kress95$kress95$Element_Layout$footer,
								_1: {ctor: '[]'}
							}
						}
					}
...
var _kress95$kress95$Views_Home$update = F3(
	function (config, msg, model) {
		var _p8 = msg;
		return A2(
			_elm_lang$core$Task$perform,
			config.apply,
			_elm_lang$core$Task$succeed(model));
	});
var _kress95$kress95$Views_Home$init = function (config) {
	return A2(
		_elm_lang$core$Task$perform,
		config.apply,
		_elm_lang$core$Task$succeed(
...
var _kress95$kress95$Views_Home$Model = function (a) {
	return {page: a};
};
var _kress95$kress95$Views_Home$Todo = {ctor: 'Todo'};

var _kress95$kress95$Main$Model = F2(
	function (a, b) {
		return {route: a, view: b};
	});
var _kress95$kress95$Main$HomeView = function (a) {
	return {ctor: 'HomeView', _0: a};
};
var _kress95$kress95$Main$ForHome = F2(
	function (a, b) {
		return {ctor: 'ForHome', _0: a, _1: b};
	});
var _kress95$kress95$Main$SetHome = function (a) {
	return {ctor: 'SetHome', _0: a};
};
var _kress95$kress95$Main$integrate = {
	home: {apply: _kress95$kress95$Main$SetHome, feedback: _kress95$kress95$Main$ForHome}
};
var _kress95$kress95$Main$view = function (_p0) {
	var _p1 = _p0;
	var page = function () {
		var _p2 = _p1.view;
		if (_p2.ctor === 'Just') {
			return A2(_kress95$kress95$Views_Home$view, _kress95$kress95$Main$integrate.home, _p2._0._0);
		} else {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _kress95$kress95$Element_Style$style,
				_1: {ctor: '[]'}
			}
		});
};
var _kress95$kress95$Main$subscriptions = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4.view;
	if (_p5.ctor === 'Just') {
		return A2(_kress95$kress95$Views_Home$subscriptions, _kress95$kress95$Main$integrate.home, _p5._0._0);
	} else {
		return _elm_lang$core$Platform_Sub$none;
	}
};
var _kress95$kress95$Main$urlChange = F2(
	function (location, model) {
		var route = _kress95$kress95$Route$fromLocation(location);
		var load = function () {
			var _p6 = route;
			if ((_p6.ctor === 'Just') && (_p6._0.ctor === 'Home')) {
				return _kress95$kress95$Views_Home$init(_kress95$kress95$Main$integrate.home);
			} else {
				return _elm_lang$core$Platform_Cmd$none;
			}
		}();
		return A2(
			_kress95$kress95$Misc_ops['=>'],
			_elm_lang$core$Native_Utils.update(
				model,
				{route: route, view: _elm_lang$core$Maybe$Nothing}),
			load);
	});
var _kress95$kress95$Main$init = function (location) {
	return A2(
		_kress95$kress95$Main$urlChange,
		location,
		{route: _elm_lang$core$Maybe$Nothing, view: _elm_lang$core$Maybe$Nothing});
};
var _kress95$kress95$Main$update = function () {
	var home = F2(
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					view: _elm_lang$core$Maybe$Just(
						_kress95$kress95$Main$HomeView(child))
				});
		});
	var update = F2(
		function (msg, model) {
			...
			switch (_p7.ctor) {
				case 'UrlChange':
					return A2(_kress95$kress95$Main$urlChange, _p7._0, model);
				case 'SetHome':
					return A2(
						_kress95$kress95$Misc_ops['=>'],
						A2(home, _p7._0, model),
						_elm_lang$core$Platform_Cmd$none);
				default:
					var _p8 = _p7._0;
					return A2(
						_kress95$kress95$Misc_ops['=>'],
						A2(home, _p8, model),
						A3(_kress95$kress95$Views_Home$update, _kress95$kress95$Main$integrate.home, _p7._1, _p8));
			}
		});
	return update;
}();
var _kress95$kress95$Main$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _kress95$kress95$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_kress95$kress95$Main$UrlChange,
	{init: _kress95$kress95$Main$init, view: _kress95$kress95$Main$view, update: _kress95$kress95$Main$update, subscriptions: _kress95$kress95$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _kress95$kress95$Main$main !== 'undefined') {
    _kress95$kress95$Main$main(Elm['Main'], 'Main', undefined);
}
